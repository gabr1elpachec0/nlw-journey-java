...
public class ParticipantService {
    ...
    public ParticipantConfirmationResponse registerParticipantToEvent(String email, Trip trip) {
        Participant newParticipant = new Participant(email, trip);
        this.repository.save(newParticipant);

        return new ParticipantConfirmationResponse(newParticipant.getId());
    }
